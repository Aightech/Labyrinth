...
distance from the player to the current node \index{\+\_\+\+Node@{\+\_\+\+Node}!heuristic@{heuristic}}
...
distance between the player and the treasure as the crows fly \index{\+\_\+\+Node@{\+\_\+\+Node}!list\+Next@{list\+Next}}
...
used if in Closedlist and Openlist \index{\+\_\+\+Node@{\+\_\+\+Node}!ncase@{ncase}}
...
pointer to a case of the map in order to get the data of \index{\+\_\+\+Node@{\+\_\+\+Node}!path\+Child@{path\+Child}}
...
pointer to get the Node evaluated after \index{\+\_\+\+Node@{\+\_\+\+Node}!path\+Parent@{path\+Parent}}
...
pointer to get the Node evaluated before \index{\+\_\+\+Node@{\+\_\+\+Node}!X@{X}}
