...
energy of the player, +1 every turn, -\/5 if the move is a rotation \index{\+\_\+\+Player@{\+\_\+\+Player}!lastX@{lastX}}
...
last X position of the player \index{\+\_\+\+Player@{\+\_\+\+Player}!lastY@{lastY}}
...
last Y position of the player \index{\+\_\+\+Player@{\+\_\+\+Player}!mode@{mode}}
...
dumb, manual, random, A$\ast$, smart A$\ast$ \index{\+\_\+\+Player@{\+\_\+\+Player}!to\+Goal@{to\+Goal}}
...
\hyperlink{struct_path}{Path} to go to the treasure \index{\+\_\+\+Player@{\+\_\+\+Player}!to\+OtherP@{to\+OtherP}}
...
\hyperlink{struct_path}{Path} to go to the opponnent \index{\+\_\+\+Player@{\+\_\+\+Player}!turn@{turn}}
...
1 if it is the turn of the player, 0 if it is the turn of the opponnent \index{\+\_\+\+Player@{\+\_\+\+Player}!X@{X}}
...
current X position of the player \index{\+\_\+\+Player@{\+\_\+\+Player}!Y@{Y}}
