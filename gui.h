...
/*! \fn void initGUI(Map * L);
    \brief  Allocate and initialize all the GUI structures.
    \param L The labyrinth map structure.
    \param lstGUIh last choice in the gui to make the active button to keep being activ after being push if there is no windows switch.
*/
...
/*! \fn char * selectL(Map *L, int w, int starty, int startx, char ** list,int sizeL);
